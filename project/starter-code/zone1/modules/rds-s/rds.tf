...
variable primary_db_cluster_instance_arn0 {}
variable primary_db_cluster_instance_arn1 {}
...
resource "aws_rds_cluster" "udacity_cluster-s" {
  ...
  depends_on = [var.primary_db_cluster_instance_arn0, var.primary_db_cluster_instance_arn1, aws_rds_cluster_parameter_group.cluster_pg-s]
}
